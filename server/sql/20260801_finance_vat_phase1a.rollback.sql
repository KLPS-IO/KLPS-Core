...
-- evidence.supplier_name predates Phase 1A and must survive this rollback.
ALTER TABLE finance_os.evidence DROP COLUMN IF EXISTS vat_evidence_type,DROP COLUMN IF EXISTS supplier_reference;
